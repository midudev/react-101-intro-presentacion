...
<script>
  ReactDOM.render(
    React.createElement(Hola),  // el qué
    document.getElementById("contenedor-app") // dónde
  )
</script>
```
---
...
###### usando servicio `http://i.pravatar.cc/100`
...
---
# ¡Gracias! 🙇‍♂️
### ¿Alguna pregunta?<br />¿Os puedo ayudar en algo?
## <br />
